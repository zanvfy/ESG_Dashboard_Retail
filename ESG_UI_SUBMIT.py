...
def submit_waste_data():
    ...
    food_wastage = EUI.food_wastage_entry.get()
    food_wastage_units = EUI.food_wastage_units_entry.get()
    plastic_wastage = EUI.plastic_wastage_entry.get()
    plastic_wastage_units = EUI.plastic_wastage_units_entry.get()
    paper_wastage = EUI.paper_wastage_entry.get()
    paper_waste_units = EUI.paper_waste_units_entry.get()
...
def submit_energy_data():
    ...
    light_consumption = EUI.light_consumption_entry.get()
    light_consumption_units = EUI.light_consumption_units_entry.get()
    temp_outside = EUI.temp_outside_entry.get()
    temp_outside_units = EUI.temp_outside_units_entry.get()
    temp_inside = EUI.temp_inside_entry.get()
    temp_inside_units = EUI.temp_inside_units_entry.get()
    refrigerator_usage = EUI.refrigerator_usage_entry.get()
    refrigerator_usage_units = EUI.refrigerator_usage_units_entry.get()
...
def submit_water_data():
    ...
    drinking_water_consumption = EUI.drinking_water_consumption_entry.get()
    drinking_water_consumption_units = EUI.drinking_water_consumption_units_entry.get()
    washroom_water_consumption = EUI.washroom_water_consumption_entry.get()
    washroom_water_consumption_units = EUI.washroom_water_consumption_units_entry.get()
    other_purpose_consumption = EUI.other_purpose_consumption_entry.get()
    other_purpose_consumption_units = EUI.other_purpose_consumption_units_entry.get()
...
def submit_fuel_data():
    ...
    gasoline_consumed = EUI.gasoline_consumed_entry.get()
    gasoline_consumed_units = EUI.gasoline_consumed_units_entry.get()
    diesel_consumed = EUI.diesel_consumed_entry.get()
    diesel_consumed_units = EUI.diesel_consumed_units_entry.get()
    electric_consumed = EUI.electric_consumed_entry.get()
    electric_consumed_units = EUI.electric_consumed_units_entry.get()
